...
def _sqlite_pragmas(dbapi_conn, _):
    ...
    try:
        ...
        print(f"⚠️ supplements.db 无法设置 WAL 模式: {e}，使用默认 DELETE 模式")
...
def migrate_database():
    ...
    with engine.connect() as conn:
        ...
        if "聲韻調" not in columns:
            print("⚠️ 检测到 informations 表缺少'聲韻調'列，正在添加...")
            ...
            conn.commit()
            print("✅ '聲韻調'列及索引已成功添加到 informations 表")
        else:
            print("✅ informations 表结构正常，包含'聲韻調'列")

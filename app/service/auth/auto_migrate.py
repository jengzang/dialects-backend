    ...
    try:
        with migration_lock(db):
            ...
            if ("table", "secret_keys") in issues:
                ...
                from app.service.auth.migrations.add_secret_keys_table import run_migration
                run_migration()
            ...
            if ("table", "sessions") in issues or ("column", "refresh_tokens.session_id") in issues:
                ...
                from app.service.auth.migrations.migrate_to_sessions import run_migration
                run_migration()
            ...
            if ("column", "refresh_tokens.ip_address") in issues or ("column", "refresh_tokens.device_info") in issues:
                ...
                from app.service.auth.migrations.add_refresh_token_tracking_fields import run_migration
                run_migration()

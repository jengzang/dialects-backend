...
col_map = {
    '漢字': ['漢字_程序改名', '單字', '#漢字', '单字', '漢字', 'phrase', '汉字', '字', '詞', '词', '字組', '字组'],
    '音標': ['IPA_程序改名', 'IPA', 'ipa', '音標', 'syllable', '音标', '讀音', '读音', '发音', '發音', 'phon', '拼音', 'pinyin'],
    '解釋': ['注釋_程序改名', '注释', '注釋', '解釋', 'notes']
}

# 跳跳老鼠格式：讀音列別名（精確匹配）
TT_PHON_ALIASES = {'讀音', '音標', '音标', 'IPA', 'ipa', 'syllable', '读音', '发音', '發音', 'phon', '拼音', 'pinyin'}

# 跳跳老鼠格式：字組列別名（精確匹配）
TT_CHAR_ALIASES = {'字組', '字组', '單字', '单字', '漢字', '汉字', 'char', 'word', '字', '詞', '词'}

# 縣志 Excel 格式：拼音列別名（精確匹配）
XZ_BASE_ALIASES = {'拼音', 'pinyin', '音韻', '音韵', '讀音', '读音', '發音', '发音', '音標', '音标', 'IPA', 'ipa', 'phon'}

# 縣志 Excel 格式：無列名時的表頭關鍵詞（子串檢測）
XZ_HEADER_TERMS = {'韻母', '拼音', '漢字', '單字', '音標', '#漢字', '声母', '韻母', '聲母', '音标', '汉字', '单字', '字組', '字组'}
...
vowel_pattern = r"[iyɨʉɯuɪʏɿʅʅɭıɪſɩɷʮɥʯʊeɘɵəɤoοоɛεɝɚᴇœɜɞʌɔæaɶɑɒᴀɐãẽĩỹõúαᵘᶷᶤᶶᵚʸᶦᵊⁱ◌øɻβʝɹǝуеṃṇīā∅Øǝ]"

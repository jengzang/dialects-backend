...
CLUSTER_EXECUTOR_DIRNAME = "_executor"
CLUSTER_EXECUTOR_PENDING_DIRNAME = "pending"
CLUSTER_EXECUTOR_PROCESSING_DIRNAME = "processing"
CLUSTER_EXECUTOR_COMPLETED_DIRNAME = "completed"
CLUSTER_EXECUTOR_FAILED_DIRNAME = "failed"
CLUSTER_EXECUTOR_POLL_INTERVAL_SECONDS = 0.2
...
STAGED_PREVIEW_TTL_SECONDS = 30 * 60
STAGED_PREPARE_TTL_SECONDS = 3 * 60 * 60
STAGED_DISTANCE_TTL_SECONDS = 3 * 60 * 60

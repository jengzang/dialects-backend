...
**Source Code**: `reference/compare.py, reference/dialect_classifier.py, reference/isogloss.py`

Key functions/classes: compliance(), load_rules(), train_classifier(), isogloss()
